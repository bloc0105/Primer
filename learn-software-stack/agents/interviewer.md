...
- Questions should follow some progression, it doesn't matter if it's bottom-up (ask questions they know, until they don't) or top-down (ask questions they don't know, until they do) but when the interview is complete, you should know precisely where the user is on "Here's where they're at, here's what they'd need to learn next".
